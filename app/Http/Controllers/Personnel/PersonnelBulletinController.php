...
class PersonnelBulletinController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('personnel.bulletin.index', [
    ...
    public function destroy(Bulletin $bulletin)
    {
        ...
        return redirect()->route('personnel.bulletin.index')
    ...
    public function download(Bulletin $bulletin)
    {
        ...
        $lines = [
            ...
            'Interne : '.($bulletin->eleve?->interne ? 'Oui' : 'Non'),
            'Affecté : '.($bulletin->eleve?->affecte ? 'Oui' : 'Non'),
    ...
    public function downloadPdf(Bulletin $bulletin)
    {
        ...
        return \Barryvdh\DomPDF\Facade\Pdf::loadView('personnel.bulletin.show', [
            'bulletin' => $bulletin,
    ...
    private function createForm(?Bulletin $bulletin = null)
    {
        ...
        return view('personnel.bulletin.formulaire', [
    ...
    private function renderBulletin(Bulletin $bulletin, bool $printMode = false)
    {
        ...
        return view('personnel.bulletin.show', compact('bulletin', 'printMode', 'annualBulletins'));
    }
