...
<div class="bg-surface-container-lowest rounded-xl custom-shadow border border-outline-variant overflow-hidden mb-6">
    ...
    <div class="px-6 pb-6">
        ...
        <div class="w-full bg-outline-variant/40 rounded-full h-3 overflow-hidden">
            <div class="h-3 rounded-full {{ $reste > 0 ? 'bg-success-green' : 'bg-success-green' }} transition-all" style="width: {{ $pourcentage }}%"></div>
        </div>
    </div>
    @endif
</div>
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-left border-collapse">
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="4" class="py-10 px-6 text-center text-on-surface-variant">Aucun paiement enregistré pour cette année.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
