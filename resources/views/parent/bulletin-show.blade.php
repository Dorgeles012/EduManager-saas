...
@if(! $isPdf)
<div class="no-print">
    <a href="{{ route('parent.enfant.bulletins', $eleve) }}" class="inline-flex items-center gap-2 px-3 py-2 text-sm text-gray-600 hover:text-primary rounded-lg">
        <span class="material-symbols-outlined text-lg">arrow_back</span> Retour
    </a>
    <div class="flex gap-2">
        <a href="{{ route('parent.enfant.bulletins.print', [$eleve, $bulletin]) }}" target="_blank" class="inline-flex items-center gap-2 px-3 py-2 text-sm text-secondary hover:bg-secondary-container/20 rounded-lg">
            <span class="material-symbols-outlined">print</span> Imprimer
        </a>
        <a href="{{ route('parent.enfant.bulletins.download-pdf', [$eleve, $bulletin]) }}" class="inline-flex items-center gap-2 px-3 py-2 text-sm text-warning-amber hover:bg-warning-amber/10 rounded-lg">
