...
<script>
    ...
    function openEditModal(id) {
        ...
        if (year) {
            ...
            form.action = "{{ url('personnel/annee-academique') }}/" + id;
    ...
    function confirmDelete(id, libelle) {
        Swal.fire({
            ...
            html: `<div class="text-center"><p>Vous êtes sur le point de supprimer :</p><p class="font-bold text-red-600 my-2">"${libelle}"</p></div>`,
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                if (form) {
                    Swal.fire({ title: 'Suppression en cours...', text: 'Veuillez patienter', icon: 'info', showConfirmButton: false, allowOutsideClick: false, didOpen: () => Swal.showLoading() });
                    form.submit();
                }
            }
        });
