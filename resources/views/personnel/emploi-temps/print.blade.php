...
@if(! $isPdf)
<div class="no-print">
    <a href="{{ route('personnel.emploi-temps.show', ['classe_id' => $classe->id, 'annee_academique_id' => $year?->id]) }}" class="inline-flex items-center gap-2 px-3 py-2 text-sm text-gray-600 hover:text-primary rounded-lg">
