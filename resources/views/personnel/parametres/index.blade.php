...
<div class="grid grid-cols-12 gap-6">
    <section class="col-span-12 lg:col-span-8 bg-surface-container-lowest rounded-2xl p-5 card-shadow border border-surface-subtle/50">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-3">
                <div class="border-b border-outline-variant/30 pb-2">
                    ...
                    <p class="text-[14px] font-semibold text-on-surface mt-1">{{ $client?->role ?? 'personnel' }}</p>
                </div>
                <div class="border-b border-outline-variant/30 pb-2">
        ...
        <div class="mt-5">
            <form method="POST" action="{{ route('personnel.parametres.update') }}" enctype="multipart/form-data" class="grid grid-cols-1 md:grid-cols-2 gap-5">
                @csrf
                @method('PUT')
        ...
        <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
                ...
                <div class="mt-4">
                    ...
                    <form method="POST" action="{{ route('personnel.parametres.password') }}" class="space-y-5">
                        @csrf
                        @method('PUT')
                        <div class="space-y-1.5">
