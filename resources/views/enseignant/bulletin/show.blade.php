...
@if(! $isPdf)
<div class="no-print">
    <a href="{{ route('enseignant.bulletin.index') }}" class="btn btn-outline-secondary" style="display:inline-flex; align-items:center; justify-content:center; width:36px; height:36px; padding:0; border-radius:50%;" title="Retour">
        <span class="material-symbols-outlined" style="font-size:20px;">arrow_back</span>
    </a>

    <div style="display:flex; gap:8px;">
        <a href="{{ route('enseignant.bulletin.download-pdf', $bulletin) }}" class="btn btn-success" style="display:inline-flex; align-items:center; gap:6px;" title="Télécharger PDF">
