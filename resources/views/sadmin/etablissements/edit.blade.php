...
<div class="flex flex-col gap-6 max-w-3xl mx-auto w-full">
    ...
    <form method="POST" action="{{ route('sadmin.etablissements.update', $etablissement) }}" class="bg-surface-container-lowest rounded-xl card-shadow border border-outline-variant p-5">
        @csrf
        @method('PUT')
